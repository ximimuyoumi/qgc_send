...
void left_listen(const sensor_msgs::Range::ConstPtr& msg_left)
{
...
int main(int argc, char **argv)
{
    ...
    while (ros::ok()) {
       ...
       // }
        ...
        //left_sonar_sub = nh.subscribe("/left_sonar", 1000, left_listen);

        right_sonar_sub = nh.subscribe("/right_sonar", 1000, right_listen);
