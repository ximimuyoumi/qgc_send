...
{  
  ...
  while(ros::ok())
  {
      ...
      obstacle_info.front_right_obstacle = int32_t(true);
      obstacle_info.front_center_obstacle = int32_t(false);
      obstacle_info.front_left_obstacle = int32_t(false);
      obstacle_info.rear_right_obstacle = int32_t(false);
      obstacle_info.rear_left_obstacle = int32_t(true);
